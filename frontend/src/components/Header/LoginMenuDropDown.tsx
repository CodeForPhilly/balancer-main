...
const LoginMenuDropDown: React.FC<LoginMenuDropDownProps> = ({
  ...
  return (
    <>
      ...
      >
        <span
          className="select-none relative group font-quicksand text-4xl font-bold text-transparent lg:text-3xl bg-gradient-to-r from-blue-500 via-blue-700 to-blue-300 bg-clip-text"
        >
          Balancer
        ...
        <p className="mb-4">
          ...
          bipolar medications, powered by Code for Philly volunteers.
        </p>
        <p className="mb-4">
          We built Balancer <b>to improve the health and well-being of people with bipolar
            disorder.</b>
        </p>
        <p className="mb-4">
...
const LoginMenu = ({ show }: {
  ...
  return (
    <div className="inset-0 z-20 bg-gray-900 opacity-50 md:fixed" />
  )
}
