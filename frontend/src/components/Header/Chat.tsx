    ...
    <>
      {showChat ? (
        ...
        <div
          ...
          className="fixed bottom-9 left-10 inline-block h-16 w-16 cursor-pointer flex items-center justify-center rounded-full bg-blue-500 object-contain hover:cursor-pointer hover:bg-blue-300 md:bottom-20 md:right-20 no-print"
        >
          <FaComments className="text-white h-10 md:h-10 md:w-10" />
